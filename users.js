...
var captcha = require('./captcha.js');
	...
	var allowedBgColors = ["666666", "888888", "AAAAAA", "adadad", "636363", "989C9E", "616161", "959594", "807E7D", "999999", "333333", "444444"];
main.on("userExists", function(conn, data){
	if(data.username){
		...
		if(data.username.toLowerCase().indexOf("vault") != -1 || data.username.toLowerCase().indexOf("admin") != -1){
